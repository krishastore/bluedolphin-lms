...
<div id="assign_quiz" class="hidden" style="max-width:463px">
	<div class="bdlms-qus-bank-modal">
		...
		<input type="text" placeholder="<?php esc_attr_e( 'Type here to search for the quiz', 'bluedolphin-lms' ); ?>" class="bdlms-qus-bank-search">
		<?php
			$args = array(
				'posts_per_page' => 5,
				'orderby'        => 'rand',
					...
					foreach ( $quizzes as $key => $quiz ) :
						...
						<li>
							<div class="bdlms-setting-checkbox">
								<input type="checkbox" class="bdlms-choose-quiz" id="bdlms-qus-<?php echo (int) $key; ?>" value="<?php echo (int) $quiz->ID; ?>">
		...
		<div class="bdlms-qus-bank-add">
			<button class="button button-primary bdlms-add-quiz" disabled><?php esc_html_e( 'Add', 'bluedolphin-lms' ); ?></button>
