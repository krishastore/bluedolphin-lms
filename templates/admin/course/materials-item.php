...
foreach ( $materials as $key => $material ) :
	...
	<div class="bdlms-materials-list-item">
		<ul>
			...
			<li class="assignment-type"><?php echo 'upload' === $method ? esc_html__( 'Upload', 'bluedolphin-lms' ) : esc_html__( 'External', 'bluedolphin-lms' ); ?></li>
			<li>
		...
		<div class="bdlms-materials-item hidden">
			<div class="bdlms-media-choose">
				...
				<input type="text" class="material-file-title" value="<?php echo isset( $material['title'] ) ? esc_attr( $material['title'] ) : ''; ?>" name="<?php echo esc_attr( $this->meta_key_prefix ); ?>[material][<?php echo (int) $key; ?>][title]" placeholder="<?php esc_attr_e( 'Enter File Title', 'bluedolphin-lms' ); ?>">
			</div>
