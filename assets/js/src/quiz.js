	...
	window.quizModule = {
        ...
        init : function() {
            ...
            $( document ).on( 'click', '.button-link.editinline', function() {
                ...
                var rightCustomBox = $( '.inline-edit-col-right:not(.inline-edit-quiz):visible' );
				var passingMarks = $( 'td.passing_marks.column-passing_marks' ).text();
				rightCustomBox.remove();
				$( '.inline-edit-quiz-item.bdlms-passing-marks:visible input', document ).val( passingMarks );
            } );
		},
