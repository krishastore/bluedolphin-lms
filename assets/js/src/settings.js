	...
	window.settingModule = {
		...
		dialogInit: function () {
			...
			$(document).on('click', '.bdlms-bulk-import', function(e) {
				...
				var column = 0;
				var importMsg = [ 
					settingObject.i18n.ImportQuestionMsgText, 
					settingObject.i18n.ImportLessonMsgText,
					settingObject.i18n.ImportCourseMsgText 
				];
				...
				modal.find('.bdlms-imported-qus h3').text(importMsg[ itemData.import_type - 1 ]);
