...
class Course extends \BlueDolphin\Lms\Collections\PostTypes {
	...
	public function save_metadata() {
		 ...
		 */
		if ( array_filter( $_POST[ $this->meta_key_prefix ]['information']['requirement'] ) ) {
		...
		if ( array_filter( $_POST[ $this->meta_key_prefix ]['information']['what_you_learn'] ) ) {
			// phpcs:ignore WordPress.Security.ValidatedSanitizedInput.MissingUnslash
			$post_data['information']['what_you_learn'] = array_map( 'sanitize_text_field', $_POST[ $this->meta_key_prefix ]['information']['what_you_learn'] );
		}
		if ( array_filter( $_POST[ $this->meta_key_prefix ]['information']['skills_you_gain'] ) ) {
			// phpcs:ignore WordPress.Security.ValidatedSanitizedInput.MissingUnslash
		...
		if ( array_filter( $_POST[ $this->meta_key_prefix ]['information']['course_includes'] ) ) {
			// phpcs:ignore WordPress.Security.ValidatedSanitizedInput.MissingUnslash
		...
		if ( array_filter( $_POST[ $this->meta_key_prefix ]['information']['faq_question'] ) ) {
			// phpcs:ignore WordPress.Security.ValidatedSanitizedInput.MissingUnslash
			$post_data['information']['faq_question'] = array_map( 'sanitize_text_field', $_POST[ $this->meta_key_prefix ]['information']['faq_question'] );
		}
		if ( array_filter( $_POST[ $this->meta_key_prefix ]['information']['faq_answer'] ) ) {
			// phpcs:ignore WordPress.Security.ValidatedSanitizedInput.MissingUnslash
